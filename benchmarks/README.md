...
| [`gate-h100-validation.md`](gate-h100-validation.md) | The method on someone else's hardware: bit-exactness at real model sizes, DeepSpeed ZeRO-3, variance | Bit-exact to 72B; 2.93x DeepSpeed ZeRO-3 offload in 9.7x less VRAM; and a silent wrong-gradient defect in the NF4 path above ~165 MiB/layer |
